...
{
    if (info_struct->current_y < 1)
        return (0);
    if (info_struct->maze[info_struct->current_y - 1]
...
{
    if (info_struct->current_y > info_struct->y - 2)
        return (0);
    if (info_struct->maze[info_struct->current_y + 1]
    [info_struct->current_x] != '*')
        return (0);
...
{
    if (info_struct->current_x > info_struct->x - 2)
        return (0);
    if (info_struct->maze[info_struct->current_y]
    [info_struct->current_x + 1] != '*')
        return (0);
