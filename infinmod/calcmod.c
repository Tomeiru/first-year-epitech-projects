...
static int do_we_div(char *fst_num, char *sec_num)
{
...
static char *divcalc(char *fst_abs, char *sec_abs)
{
    char *ans = "0";
    char *temp;
    int i = 0;
...
static char *rest(char *total, char *abs, char quotient)
{
...
char *modglob(char *fst_abs, char *sec_abs)
{
