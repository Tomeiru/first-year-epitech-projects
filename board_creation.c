...
char *create_board(void)
{
    ...
    board = my_strcat(board, "my positions:\n |A B C D E F G H\n");
    board = my_strcat(board, "-+---------------\n1|. . . . . . . .\n");
    board = my_strcat(board, "2|. . . . . . . .\n3|. . . . . . . .\n");
    board = my_strcat(board, "4|. . . . . . . .\n5|. . . . . . . .\n");
    board = my_strcat(board, "6|. . . . . . . .\n7|. . . . . . . .\n");
    board = my_strcat(board, "8|. . . . . . . .\n\n");
    board = my_strcat(board, "enemy's positions:\n |A B C D E F G H\n");
    board = my_strcat(board, "-+---------------\n1|. . . . . . . .\n");
    board = my_strcat(board, "2|. . . . . . . .\n3|. . . . . . . .\n");
    board = my_strcat(board, "4|. . . . . . . .\n5|. . . . . . . .\n");
    board = my_strcat(board, "6|. . . . . . . .\n7|. . . . . . . .\n");
