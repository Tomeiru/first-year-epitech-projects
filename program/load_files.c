...
void setpos_sprites(struct game_struct *game_man)
{
    ...
    sfSprite_setPosition(game_man->game_gui->underground, coord_to_pos(0, 1008));
    sfSprite_setPosition(game_man->game_gui->grass, coord_to_pos(0, 864));
    sfSprite_setPosition(game_man->game_gui->ground_second, coord_to_pos(2160, 936));
    sfSprite_setPosition(game_man->game_gui->underground_second, coord_to_pos(2160, 1008));
    sfSprite_setPosition(game_man->game_gui->grass_second, coord_to_pos(2160, 864));
...
void load_sprites(struct game_struct *game_man)
{
    ...
    game_man->game_gui->underground_second = filepath_to_sprite("files/Ground.png");
    ...
    game_man->game_gui->jumping_mario = filepath_to_sprite("files/jumping_mario.png");
    ...
    game_man->game_gui->game_over = filepath_to_sprite("files/gameover_screen.png");
...
void load_text(struct game_struct *game_man)
{
    ...
    sfText_setString(game_man->game_gui->score_value, print_u(game_man->game_stats->score));
    ...
    sfText_setPosition(game_man->game_gui->score_value, coord_to_pos(1000, 920));
    ...
    sfText_setPosition(game_man->game_gui->hscore_value, coord_to_pos(1370, 920));
}
